(function() {
    ...
    function initParkedPage() {
        ...
        // Make sure we have a head and body
        if (!document.head) {
    ...
    async function loadServerInfo() {
        try {
            ...
            const domainElement = document.getElementById('parked-domain');
            const serverElement = document.getElementById('parked-server');
            
            if (domainElement) {
                domainElement.textContent = domain || 'Not Available';
            }
            if (serverElement) {
                serverElement.textContent = (!serverName || serverName.trim().toLowerCase() === 'unused') 
                    ? 'Not Provisioned' 
                    : serverName;
            }
            ...
            if (serverElement) {
                serverElement.textContent = 'Not Registered';
            }
        }
    }
    ...
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initParkedPage);
    } else {
        initParkedPage();
    }
})();